...
export default function TrendingPage() {
  ...
  useEffect(() => {
    const fetchCampaigns = async () => {
      ...
      try {
        ...
        console.error("Erreur lors du chargement des projets tendance:", error);
      } finally {
        setIsLoading(false);
      }
    };
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-teal-50 mb-8">
              Découvrez les projets qui génèrent le plus d'intérêt et de soutien
              en ce moment.
            </p>
          </div>
        </div>
      ...
      {/* Featured Trending Projects Carousel */}
      {!isLoading && campaigns.length > 0 && (
        <section className="py-16 bg-white">
          <div className="container">
            <h2 className="text-2xl font-bold mb-8">
              Projets tendance à la une
            </h2>
      ...
      <section className="py-16 bg-warmgray-50">
        <div className="container">
          <h2 className="text-2xl font-bold mb-8">Tous les projets tendance</h2>
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <div className="bg-warmgray-50 rounded-lg p-8 max-w-md mx-auto">
                ...
                <p className="text-gray-600 mb-6">
                  Aucun projet tendance n'est disponible pour le moment.
                </p>
                <Button
                  asChild
                  className="bg-teal-600 hover:bg-teal-700 rounded-full"
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-8 text-center">
              Pourquoi ces projets sont tendance
            </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg border border-gray-200 text-center">
                ...
                <p className="text-gray-600">Plus de visites que la moyenne</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg border border-gray-200 text-center">
                ...
                <p className="text-gray-600">
                  Plus de contributions par visiteur
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Créez votre propre succès
            </h2>
            <p className="text-lg text-gray-600 mb-8">
              Lancez votre projet aujourd'hui et rejoignez peut-être les
              tendances de demain.
            </p>
            <Button
              asChild
